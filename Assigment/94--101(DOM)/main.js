...
addInput.onblur = function () {
  ...
  /* To Remove The Text No Classes ..... Whent We Have Classes */ let text =
...
removeInput.onblur = function () {
  ...
  /* To Delete The Clasese, IF The Same Word */ for (
    let i = 0;
    i < allSpans.length;
    i++
  ) {
  ...
  /* IF The Result Empty, Doesn't Have Classes Create Element, With Content No Classes To Show */ if (
